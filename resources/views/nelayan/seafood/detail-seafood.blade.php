            ...
            <div class="card shadow border-0">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('sefood.index') }}" class="btn btn-secondary">Kembali ke Daftar Seafood</a>
                        <a href="{{ route('seafood.edit.nelayan', ['kode_seafood' => $seafood->kode_seafood]) }}" class="btn btn-warning">Edit</a>
                    </div>
                </div>
            </div>
        </div>
