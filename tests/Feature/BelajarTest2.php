...
class BelajarTest extends TestCase
{
    ...
    public function test_masuk_dashboard_tanpa_login(): void
    {
        ...
        $response->assertSee('Dashboard', $escaped = true);
    }
    ...
    public function test_masuk_halaman_login_nelayan() : void {
        ...
        $response->assertStatus(200);
        $response->assertSee('Login Nelayan', $escaped = true);
    }
    ...
    public function test_akses_halaman_seafood_berhasil(){
        ...
        $response->assertStatus(200);
        $response->assertSee('Seafood', $escaped = true);
    }
    ...
    public function test_input_data_seafood_gagal() {
        ...
        $pathToFotoAsli = base_path('tests/fixtures/CV job fair DIOO.pdf');
        $pasFotoS = new UploadedFile($pathToFotoAsli, 'pas_foto.jpg', null, null, true);
        ...
        $response->assertRedirect()->assertSessionHasErrors('photo', 'quantity');
    }
